...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes > winning_count_counties):
            ...
            winner_percentage_counties = vote_percentage
    ...
    for candidate_name in candidate_votes:
         ...
         if (votes > winner_voteCount) and (vote_percentage > winner_percentage):
    ...
    winner_candidate_summary = (
         ...
         f"Winning Vote Count: {winner_voteCount:,}\n"
